...
function initializeServer() {
    return __awaiter(this, void 0, void 0, function () {
        var port, logger, model, server, _a, certificatePath, keyPath;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    port = getHostPort();
                    logger = new Logger_1.default();
                    model = new CSVModel_1.default();
                    server = new Server_1.default(logger, model, port);
                    _a = getHTTPSPaths(), certificatePath = _a[0], keyPath = _a[1];
                    return [4 /*yield*/, server.start(certificatePath, keyPath)];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
